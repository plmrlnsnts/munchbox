        ...
        <div class="p-4 space-y-4 mb-10">
            <div class="flex items-start space-x-4">
                ...
                <div class="text-sm space-y-1">
                    <h2 class="block font-semibold leading-tight">{{ recipe.name }}</h2>
                    <div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    ...
                    <LikeButton :likeable="recipe" model="recipes" />
                </div>
                <div>
            ...
            <ul class="space-y-4">
                <li v-for="ingredient in recipe.ingredients" :key="`ingredients-${ingredient.id}`" class="flex space-x-2">
