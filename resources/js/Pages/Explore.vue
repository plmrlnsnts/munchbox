<template>
    <div class="h-full flex flex-col items-center justify-center">
        <Portal to="header-center">
            <form>
                <div class="relative">
                    <input type="text" placeholder="Search munchbox" class="pl-10 pr-3 py-2 block w-full rounded-full border border-gray-200 bg-gray-200 focus:border-indigo-300 focus:bg-white focus:outline-none focus:shadow-outline-indigo" />
