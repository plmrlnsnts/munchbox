<template>
    <div class="h-full flex flex-col items-center justify-center">
        <Portal to="header-center">
            <form>
                <div class="relative">
                    <input type="text" placeholder="Search munchbox" class="pl-10 pr-3 py-2 block w-full font-medium sm:text-sm sm:leading-5 rounded-full bg-gray-200 focus:bg-white focus:outline-none focus:shadow-outline" />
