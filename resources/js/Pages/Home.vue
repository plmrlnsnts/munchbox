<template>
    <div class="relative h-full">
        ...
        <div class="h-full flex flex-col items-center justify-center">
            <h6 class="text-3xl">✨</h6>
            <p>Hey Jude, don't make it bad</p>
        </div>
        <InertiaLink :href="$route('recipes.create')" class="absolute bottom-4 right-4 w-12 h-12 rounded-full shadow inline-flex items-center justify-center bg-indigo-500 text-white">
