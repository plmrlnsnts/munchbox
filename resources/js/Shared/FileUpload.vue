<template>
    <div>
        <button @click="$refs.file.click()" type="button" class="relative border-2 border-dashed bg-white rounded-xl overflow-hidden h-56 w-full block focus:outline-none">
            ...
            <div v-else class="absolute inset-0 flex flex-col items-center justify-center space-y-2 ">
                ...
                <p class="text-gray-700 text-sm leading-5">Upload a thumbnail</p>
            </div>
        </button>
