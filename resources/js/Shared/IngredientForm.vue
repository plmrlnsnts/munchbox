<template>
    <div class="z-10 fixed inset-0 w-full h-full flex flex-col items-center justify-end space-y-4 bg-black bg-opacity-50">
        ...
        <form @submit.prevent="submit" class="self-stretch bg-white rounded-t-xl px-6 py-4 space-y-4">
            ...
            <div class="space-y-1">
                ...
                <div class="flex space-x-2">
                    ...
                    <input v-model="form.unit" type="text" placeholder="Unit" class="px-3 py-2 sm:text-sm sm:leading-5 block w-full rounded-lg border border-gray-200 bg-gray-200 focus:bg-white focus:outline-none focus:shadow-outline-indigo focus:border-indigo-300 transition-shadow duration-100 ease-linear">
                </div>
            </div>
            <div class="space-y-1">
